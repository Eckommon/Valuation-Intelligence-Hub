...
from valuation_hub import cli_entry_m26, cli_entry_m27, cli_entry_m28, cli_entry_m29, cli_entry_m30, cli_entry_m30r1, cli_entry_m30r2, cli_entry_m30r3, cli_entry_m30r4
...
def test_m26_cli_builds_forecast_candidate(tmp_path: Path, capsys) -> None:
    ...
    rc = cli_entry_m26.main([
        "forecast-candidate-build", str(path),
